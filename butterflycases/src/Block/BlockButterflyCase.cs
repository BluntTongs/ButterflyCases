...
namespace butterflycases
{
    public class BlockButterflyCase : Block
    {
        ...
        public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
        {
            ...
            BEButterflyCaseSlantedSmall bebcss = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BEButterflyCaseSlantedSmall;
            ...
            if (bebcss != null) return bebcss.OnInteract(byPlayer, blockSel);

    ...
    public class BEButterflyCaseWall : BEButterflyBase, IRotatable
    {
        ...
        protected override float[][] genTransformationMatrices()
        {
            ...
            for (int index = 0; index < 4; index++)
            {
                ...
                float y = (index < 2) ? 11f / 16f : 4f / 16f;
                float z = (index > 1) ? 1.2f / 16f : 1.2f / 16f;
                ...
                float originAddZ = OriginOffsetDepths();
                    ...
                    if (inventory[index].Itemstack != null && inventory[index].Itemstack.Collectible is ItemDeadButterfly)
                        ...
                        new Matrixf()
                        .RotateY(originRot)
                        .Translate(x + originAddX, y, z + originAddZ)
                        .RotateXDeg(90)
                        .RotateYDeg(45)
                       ...
                       tfMatrices[index] =
                        new Matrixf()
                        .RotateY(originRot)
                        .Translate(x + originAddX + 0.01f, y + 0.07f, z + originAddZ - 0.07f)
                        .RotateXDeg(90)
                        .RotateYDeg(45)

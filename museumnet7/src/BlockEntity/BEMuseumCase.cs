...
{
    public class BEMuseumCase : BEMuseumBase, IRotatable
    {
        public override string InventoryClassName => "museumcase";
        ...
        public BEMuseumCase()
        {
            inventory = new InventoryDisplayed(this, 4, "museumcase-0", null, null);
        }
        ...
        public override void ToTreeAttributes(Vintagestory.API.Datastructures.ITreeAttribute tree)
        {
            ...
            tree.SetBool("peg0", peg[0]);
            tree.SetBool("peg1", peg[1]);
            tree.SetBool("peg2", peg[2]);
            tree.SetBool("peg3", peg[3]);

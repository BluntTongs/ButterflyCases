...
{
    public class BEMuseumCaseButterfly : BEMuseumBase, IRotatable
    {
        public override string InventoryClassName => "museumcasebutterfly";
        ...
        public BEMuseumCaseButterfly()
        {
            inventory = new InventoryDisplayed(this, 4, "museumcasebutterfly-0", null, null);
        }
